$(LIBSAIREDIS)_DEB_BUILD_PROFILES += syncd vs_custom

SYNCD_VS_CUSTOM = syncd-vs_custom_1.0.0_$(CONFIGURED_ARCH).deb
$(SYNCD_VS_CUSTOM)_RDEPENDS += $(LIBSAIREDIS) $(LIBSAIMETADATA) $(LIBSAIVS)

ifeq ($(INCLUDE_VS_CUSTOM_DASH_SAI),y)
ifeq ($(BLDENV),bookworm)
# dash-sai only support sonic-vs_custom.img.gz. it don't support docker-sonic-vs_custom.gz
ifeq ($(findstring docker-sonic-vs_custom, $(SONIC_BUILD_TARGET)), )
...
SYNCD_VS_CUSTOM_DBG = syncd-vs_custom-dbgsym_1.0.0_$(CONFIGURED_ARCH).deb
